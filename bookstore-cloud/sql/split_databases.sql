-- ================================================
-- 网上书店微服务 - 数据库拆分脚本
-- 将原 bookstore 库拆分为 3 个独立数据库
-- ================================================

-- ================================================
-- 1. 用户服务数据库 bookstore_user
-- 包含: admin, user, shop, address, cart 表
-- ================================================
CREATE DATABASE IF NOT EXISTS bookstore_user DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE bookstore_user;
...
-- ================================================
-- 2. 图书服务数据库 bookstore_book
-- 包含: book, book_image, category 表
-- ================================================
CREATE DATABASE IF NOT EXISTS bookstore_book DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE bookstore_book;
...
-- ================================================
-- 3. 订单服务数据库 bookstore_order
-- 包含: order, order_item, review 表
-- ================================================
CREATE DATABASE IF NOT EXISTS bookstore_order DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE bookstore_order;
...
-- 完成提示
-- ================================================
SELECT '微服务数据库拆分完成！共创建 3 个数据库：bookstore_user, bookstore_book, bookstore_order' AS '结果';
